// CENG 407 AUTONOMOUS VEHICLE ESP32 IMPLEMENTATION
...
const char* ssid = "DESKTOP-B0LSANN 8013";   
const char* password = "T1n0933,"; 
...
void setup(void) {
  ...
  ledcAttachPin(PIN_SERVO_PITCH, SERVO_PITCH_CHANNEL);
  servoWrite(SERVO_PITCH_CHANNEL, posServo);
